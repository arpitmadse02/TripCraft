...
function HotelCardItem({ hotel }) {
  ...
  return (
    <Link
      ...
      target="_blank"
    >
      <div className="transition-all bg-gray-50 w-full shadow-md border border-black/5 h-full rounded-xl p-3 cursor-pointer hover:scale-105">
        <img
        ...
        <div className="flex flex-col gap-2 my-3">
          <h2 className="font-medium p-1 text-gray-900">{hotel?.hotelName}</h2>
          ...
          <h2 className="flex items-center mt-2 gap-2 text-xs text-gray-900">
            <img
