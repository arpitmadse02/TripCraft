...
const apiKey = import.meta.env.VITE_GGOGLE_GEMINI_AI_API_KEY;
...
2. Provide a "hotelOptions" array (more than 15) with hotelName, hotelAddress, price in indian rupees, hotelImageUrl, geoCoordinates, rating, description.
3. Provide an "itinerary" array with EXACTLY 3 days.
4. EACH day MUST contain EXACTLY 3 plans:
   - morning
   - afternoon
   - evening
5. Do NOT add extra plans.
6. Do NOT skip any time slot.
