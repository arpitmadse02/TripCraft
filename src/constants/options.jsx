...
export const SelectTravelesList = [
  {
    ...
    icon: <FaPlaneDeparture size={20} className="text-[#43a5c0]" />,
    people: "1 Traveler",
  },
  {
    id: 2,
    ...
    icon: <FaGlassCheers size={20} className="text-[#43a5c0]" />,
    people: "2 Travelers",
  },
  {
    id: 3,
    ...
    icon: <FaHome size={20} className="text-[#43a5c0]" />,
    people: "3-5 Members",
  },
  {
    id: 4,
    ...
    icon: <FaUsers size={20} className="text-[#43a5c0]" />,
...
export const SelectBudgetOptions = [
  {
    ...
    icon: <FaMoneyBillWave size={20} className="text-[#43a5c0]" />,
  },
  {
    id: 2,
    title: "Mid-Range",
    //desc: "Enjoy a balance of comfort and value.",
    icon: <FaMoneyCheckAlt size={20} className="text-[#43a5c0]" />,
  },
  {
    id: 3,
    title: "Luxury",
    //desc: "Indulge in premium experiences without limits.",
    icon: <FaGem size={20} className="text-[#43a5c0]" />,
  },
];
